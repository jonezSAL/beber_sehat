...
<div class="container">
    ...
    $sql = "SELECT * FROM patients WHERE poli = 'UMUM'";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<form method='post' action='updatedoc.php'>"; // Open a new form for the edit button
            echo "<input type='hidden' name='id_pasien' value='" . $row["antrian"]. "'>"; // Added hidden input field
            echo "<button type='submit' action='updatedoc.php' name='edit'>Edit</button>";
            echo "</form>"; // Close the form for the edit button
